...
pretrained_weight_path = r'../weight/baseline.pth'
save_predict_path = rf'../result/predict.csv'

# read class_indict
json_path = r'./five_class_indices.json'
...
for grade in ['grade0','grade1','grade2','grade3','grade4']:
    img_dir = rf'../data/fiveclass-train/val/{grade}'
